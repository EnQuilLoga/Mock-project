            ...
            <nav className="my-5">
              <ul className="flex items-center text-xs gap-x-3 lg:gap-x-5 lg:text-sm xl:gap-x-7 xl:text-base">
                ...
                <li className="group relative">
                  <div className="group-hover:text-red-500 font-bold">
                    <NavLink
                      to={"bags-shoes"}
                      className={({ isActive, isPending }) =>
                        isPending ? "pending " : isActive ? "text-red-500" : ""
                  ...
                  <div className="bg-slate-400 text-white absolute opacity-0 -z-10 translate-y-0 invisible transition ease-linear delay-300 group-hover:opacity-100 group-hover:visible group-hover:z-50">
                    <div className="flex">
                      <div>
                      ...
                      <div>
                        <Link to={"luggage-bags"} className="hover:text-red-500">
                          LUGGAGE & BAGS
                        </Link>
                        <ul>
                          <li className="hover:text-red-500">
                      ...
                      <div>
                        <Link to={"other-bags-accessories"} className="hover:text-red-500">
                ...
                <li className="group relative">
                  ...
                  <div className="bg-slate-400 text-white absolute top-auto opacity-0 -z-10 invisible transition ease-linear delay-300 group-hover:opacity-100 group-hover:visible group-hover:z-50">
                    <ul>
                      <li className="hover:text-red-500">
                        <Link to={"women-shoes"}>Women Shoes</Link>
                      </li>
